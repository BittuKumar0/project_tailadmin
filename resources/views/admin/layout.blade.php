...
<head>
    ...
    <title>Admin Dashboard | Farmkart</title>
    ...
    <nav id="sidebar">
        <div class="logo-section p-4 text-white">
            <div class="d-flex align-items-center gap-3">
                <div class="bg-white bg-opacity-20 rounded-4 p-2">
                    <i class="fas fa-leaf fs-4"></i>
                </div>
                <div>
                    <h4 class="mb-0 fw-bold">Farm<span class="opacity-75">kart</span></h4>
    ...
    <div class="main-wrapper">
        ...
        <header class="admin-header sticky-top py-3 px-4 d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex align-items-center">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-sm mb-0">
                        <li class="breadcrumb-item"><a href="#" class="text-muted"><i class="fas fa-home me-1"></i>Home</a></li>
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <!-- Notifications -->
                <button class="btn btn-outline-light btn-sm position-relative p-2">
                ...
                <div class="dropdown">
                    <a href="#" class="d-flex align-items-center text-decoration-none gap-2" data-bs-toggle="dropdown">
                        ...
                        <div class="text-start d-none d-md-block">
                            ...
                            <small class="fw-bold">Super Admin</small>
                        </div>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0 mt-2">
                        <li><a class="dropdown-item d-flex align-items-center gap-2" href="#"><i class="fas fa-user text-muted"></i>Profile</a></li>
                        <li><a class="dropdown-item d-flex align-items-center gap-2" href="#"><i class="fas fa-cog text-muted"></i>Settings</a></li>
                        <li><hr class="dropdown-divider"></li>
                        <li><a class="dropdown-item text-danger d-flex align-items-center gap-2" href="#"><i class="fas fa-sign-out-alt"></i>Logout</a></li>
                    </ul>
                </div>
            </div>
        </header>
